...
export const SETTINGS_TABS: SettingsTab[] = [
  {
    ...
    icon: Building2,
    locked: false,
    blurb: "Workspace name and identifiers.",
  },
  {
    label: "Members",
  ...
  },
  {
    ...
    icon: Cable,
    locked: false,
    blurb: "The Company MCP Server this workspace's agent can reach.",
  },
  {
    label: "Models & cost",
    ...
    locked: false,
    blurb: "The live model lineup, budgets and token prices — read-only.",
  },
  {
    label: "Appearance",
